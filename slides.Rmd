...
- Example: we extract the most recent [Australian Open Tennis Championships (AUS Open) atch results](http://www.tennis-data.co.uk/ausopen.php):
...
How would R store them? 
     ...
     - vector, data frame, list, lists of lists ...
...
kable(score_raptor_2018, "html",align="cccccc") %>%
    kable_styling(font_size = 13,position = "left") %>%
    scroll_box(width = "1000px", height = "170px")
```
