...
- source code of the slides and all the examples:
  [https://github.com/wanwanx/WebScraping_UCSAS/][source-repo]

- prerequisites: Previous experience with R; a laptop with [R][cran] and [RStudio IDE][rstudio-ide]      preinstalled.
